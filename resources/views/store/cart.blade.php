            ...
            <div class="col-md-5 order-details" style="width: 100%;">
                ...
                <div id="order_summary" class="order-summary">
					...
					@if($c[0]==$p->id)
                        ...
                        <input type="number"  id="quantity" style="width:25%" name={{$p->id}} value={{$c[1]}} min="1" max="100" readonly/>
...
<!--                            -->
                ...
                <div class="payment-method float-left">
                    <ul class="list-unstyled">
                        <li>
                        <input type="radio" name="payment" id="payment-2" value="Unpaid" checked>
                        <label for="payment-2">
                            <span></span>
                            Cash On Delivery
                        </label>
                        ...
                        <div class="caption">
                            <p>The product Will be delivered within 24 hour of confirmation. We accept Cash on delivery at this moment.</p>
                        </div>
                        </li>

                        <li>
                        <input type="radio" name="payment" id="payment-2" value="Paid">
                        <label for="payment-2">
                            <span></span>
                            Digital Payment
                        </label>
                        ...
                        <div class="caption">
                            <p>The product Will be delivered within 24 hour of confirmation. We accept also Digital Payment on delivery at this moment.</p>
                        </div>
                        </li>
