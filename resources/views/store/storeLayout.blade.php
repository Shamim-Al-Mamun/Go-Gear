        ...
        <div id="top-header">
            <div class="container">
                <ul id="head_links" class="header-links pull-left">
                    <li><a href="#"><i class="fa fa-phone"></i> +8801840049193</a></li>
                    <li><a href="#"><i class="fa fa-envelope-o"></i> support@gearandgo.com</a></li>
                    <li><a href="#"><i class="fa fa-map-marker"></i> B#, H-1, Rd/1, Banasree, Rampura, Dhaka-1219</a></li>

                </ul>
                <ul class="header-links pull-right">
                    @if(session()->has('user'))
                      <li><a style="color:white" href="{{route('user.history')}}">{{session()->get('user')->full_name}} </a></li>
                      <li><a href="{{route('user.service')}}"><i class="fa fa-ticket"></i> Service booking</a></li>
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="{{route('user.home')}}" class="logo">
                                <img src="{{asset('img/logo-bike.png')}}" style="height: 70px" alt="">
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
                        ...
                        <div class="header-search">
                            <form action="{{route('user.search')}}" method="get">
                                <div class="custom_search_top" >
                                    <input class="input" style="border-radius: 40px 0px 0px 40px; margin-left: 100px" name="n" placeholder="Search here">
                ...
                <div class="row" >
                    <div class="col-md-3 col-xs-6" >
                        <div class="footer" >
                            ...
                            <p>You can buy anything for your favorite bike from Gear & GO with reasonable price. Just check this out.</p>
