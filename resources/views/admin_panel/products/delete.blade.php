                                ...
                                < Back to List</a>
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="Total_Stock" value="{{$product->total_stock}}">
                                        </div>
                                        <div class="form-group">
                                            <label >Bought Price</label>
                                            <input type="text" class="form-control"  name="Bought_Price" value="{{$product->per_price}}">
                                        </div>
