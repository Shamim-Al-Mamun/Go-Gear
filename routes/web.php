...
Route::group(['middleware' => 'admin'], function(){
    ...
    //booking management
    Route::get('/admin_panel/service', 'admin_panel\managementController@manageBooking')->name('admin.bookingManagement');
    Route::post('/admin_panel/service', 'admin_panel\managementController@updateBooking')->name('admin.orderUpdate');
...
Route::get('/service', 'user\userController@serviceIndex')->name('user.service');
Route::post('/service', 'user\userController@confirmService');
...
Route::get('/payment', 'SslCommerzPaymentController@exampleHostedCheckout')->name('user.payment');;
