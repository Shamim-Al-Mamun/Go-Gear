   ...
   public function index()
    ...
    public function store(ProductVerifyRequest $request)
    {
        try {
            ...
            $per_price = ($product_price* $discount_price) / 100;
            $main_price = $product_price - $per_price;
            ...
            $prd->price = $main_price;
            $prd->discount = $request->Discounted_Price;
            $prd->total_stock = $request->Total_Stock;
            $prd->per_price = $request->Bought_Price;
    ...
    public function update(ProductEditVerifyRequest $request, $id)
    {
        ...
        $prdToUpdate->total_stock = $request->Total_Stock;
        $prdToUpdate->per_price = $request->Bought_Price;
